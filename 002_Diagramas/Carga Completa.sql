...
VALUES(uuid(), 'admin', 'Administrador', '', '', true, 'admin@admin.com', '$2b$08$V12M9bkzVOMh2K/qN4/dse3.O3xrZyQpmNYpFiytu1Om.AsLy9w/m', 'administrador',current_timestamp,current_timestamp);
